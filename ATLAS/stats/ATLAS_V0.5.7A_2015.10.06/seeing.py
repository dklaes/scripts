...
# l1
if os.path.isfile('seeing_u_SDSS.txt'):
...
# l2
if os.path.isfile('seeing_g_SDSS.txt'):
...
# l3
if os.path.isfile('seeing_r_SDSS.txt'):
...
# l4
if os.path.isfile('seeing_i_SDSS.txt'):
...
# l5
if os.path.isfile('seeing_z_SDSS.txt'):
...
# r1
if os.path.isfile('seeing_individual_u_SDSS.txt'):
...
# r2
if os.path.isfile('seeing_individual_g_SDSS.txt'):
...
# r3
if os.path.isfile('seeing_individual_r_SDSS.txt'):
...
# r4
if os.path.isfile('seeing_individual_i_SDSS.txt'):
...
# r5
if os.path.isfile('seeing_individual_z_SDSS.txt'):
